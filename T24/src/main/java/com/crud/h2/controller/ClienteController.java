...
public class ClienteController {
	...
	public List<Cliente> listarClienteTrabajo(@PathVariable(name="trabajo") String nombre) {
	    return clienteServideImpl.listarClienteTrabajo(nombre);
	}
	...
	public Cliente actualizarCliente(@PathVariable(name="id")Long id,@RequestBody Cliente cliente) {
		...
		cliente_seleccionado.setSalario(cliente.getTrabajo().setearSueldo(cliente.getTrabajo().getNombreTrabajo()));
